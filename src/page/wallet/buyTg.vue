<template>
  <div>
    <van-notice-bar
      text="目前TG仅以内部形式发放，公链上线后开放认购，敬请期待。"
    />
    <div class="body">
      <div class="box text-left">
        <div class="box">
          <van-cell-group>
            <van-cell title="合约名称" value="TG"/>
        ...
        <van-field placeholder="请输入要购入的数量"></van-field>
        <van-button disabled class="button-orange" style="margin-top: 10%;margin-bottom: 10%" type="default"
                    size="large">
          立即购买
        </van-button>
      </div>
...
<script>
  import Vue from 'vue';
  import {Field, Button, CellGroup, Cell, NoticeBar} from 'vant';
